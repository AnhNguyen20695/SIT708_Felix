...
public class FoundModel {
    ...
    public FoundModel(Integer id, String name, String phoneNumber, String description, String reportedDate, String location, String locationLatitude, String locationLongitude) {
        this.id = id;
        this.name = name;
        this.phoneNumber = phoneNumber;
        this.description = description;

...
import com.example.chatbotv2.databinding.ActivitySignUpBinding;
...
//            Intent intent = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
            ...
            Log.d("MAIN_LOG", "Clicked profile image. Select..");
    ...
    private final ActivityResultLauncher<Intent> pickImage = registerForActivityResult(
            ...
            result -> {
                Log.d("MAIN_LOG", "Displaying stored images. Result code: "+result.getResultCode());
                if (result.getResultCode() == RESULT_OK) {
                    if (result.getData() != null) {
                        ...
                        try {
                            ...
                            Log.d("MAIN_LOG", "Can not load images to pick for profile. Error: "+e);
                        }
                    }
                }
            }
